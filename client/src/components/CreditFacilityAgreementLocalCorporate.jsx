  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-3xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950/60">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-3 gap-y-3 text-sm text-zinc-700 dark:text-zinc-300">
          ...
          <InlineInput
            ...
            onChange={(v) => {
              ...
              update("creditFacility.date.day", next);
            }}
            placeholder="Date"
            disabled={busy}
            className="w-28"
          ...
          <InlineInput
            ...
            onChange={(v) => {
              ...
              update("creditFacility.date.month", next);
            }}
            placeholder="Month"
            disabled={busy}
            className="w-40"
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3 text-xs text-zinc-600 dark:text-zinc-300/90">
          ...
          <InlineInput
            ...
            onChange={(v) => {
              ...
              update("creditFacility.execution.date", next);
            }}
            placeholder="Date"
            disabled={busy}
            className="w-24"
          ...
          <InlineInput
            ...
            onChange={(v) => {
              ...
              update("creditFacility.execution.month", next);
            }}
            placeholder="Month"
            disabled={busy}
            className="w-32"
        ...
        <br></br>
        <div className="text-xs text-zinc-300 mb-2">Witness</div>
