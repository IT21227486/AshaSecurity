        ...
        <div className="px-6 py-6">
          ...
          <Card className="mt-4">
            ...
            <div className="px-6 py-6">
              ...
              <div className="mt-6 text-xs font-semibold tracking-wide text-zinc-200">
          ...
          <Card className="mt-4">
            ...
            <div className="px-6 py-6">
              ...
              <InfoBox>
                agree and acknowledge that the following risks involved in investing / trading in securities listed
                on the Colombo Stock Exchange ( “Risk Disclosure Statements” ) were explained to me/us by
              </InfoBox>

              <Field label="">
                <Input path="fiDeclaration.schedule2.explainedByName"
                  value={s2.explainedByName || ""}
                  onChange={(e) =>
                    update("fiDeclaration.schedule2.explainedByName", e.target.value)
                  }
                  placeholder="Name"
                  disabled={busy}
                />
