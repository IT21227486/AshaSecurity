...
function InfoBox({ children }) {
  return (
    <div className="mt-4 rounded-3xl border border-white/10 bg-white/[0.03] p-4 text-xs leading-relaxed text-zinc-300">
      {children}
    </div>
  );
}
...
function PartyBlock({ label, basePath, data, update, busy, locked = false }) {
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-4">
      <div className="mb-3 text-xs font-semibold tracking-wide text-zinc-200">
        {label}
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="grid grid-cols-1 gap-2">
          <div className="text-xs text-zinc-400">Bearing Passport Number</div>
    ...
    <div className="space-y-8">
      <Card><center>
        ...
        <div className="px-6 py-6">
          ...
          <div className="relative">
            ...
            {/* <div className="mt-3">
              <details className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                <summary className="cursor-pointer text-xs font-semibold tracking-wide text-zinc-200">
                  View Agreement Sections (1.0 – 6.0)
                </summary>

                <div className="mt-3 max-h-[360px] overflow-auto pr-2 text-xs text-zinc-300 leading-relaxed space-y-3">
            ...
            <div className="mt-3 flex justify-end">
              <button
                ...
                className="text-xs font-semibold text-zinc-200 underline decoration-white/20 underline-offset-4 hover:decoration-white/40"
              >
          ...
          {/* <label className="mt-6 flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-950/30 p-4">
            <input
              type="checkbox"
